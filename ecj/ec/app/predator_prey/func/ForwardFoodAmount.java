...
*
*terminal that returns the amount of food in the square in front of the agent
*/
...
public class ForwardFoodAmount extends GPNode
    {
    public String toString() { return "forward-food-sensor"; }
    ...
    public void eval(final EvolutionState state,
        ...
        //finds which square is in front of the agent depending on it's facing
        switch (orientation) {
            case 0:
