...
*
*Terminal that returns the amount of food in the square to the right of the agent
*/
...
public class RightFoodAmount extends GPNode
    {
    public String toString() { return "right-food-sensor"; }
    ...
    public void eval(final EvolutionState state,
        ...
        //Finds which square is to the right of the agent depending on its facing
        switch (orientation) {
            case 0:
