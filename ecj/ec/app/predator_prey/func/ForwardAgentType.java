...
*
*Terminal that returns the agent type in the square in front of the agent
...
public class ForwardAgentType extends GPNode
    {
    public String toString() { return "forward-agent-sensor"; }
    ...
    public void eval(final EvolutionState state,
        ...
        //Finds which square is in front of the agent depending on the facing
        switch (orientation) {
            case 0:
