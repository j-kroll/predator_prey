...
*
*Terminal that returns the agent type in the square to the left of the agent
...
public class LeftAgentType extends GPNode
    {
    public String toString() { return "left-agent-sensor"; }
