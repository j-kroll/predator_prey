...
*
*Terminal that returns the agent type in the square to the right of the agent
...
public class RightAgentType extends GPNode
    {
    public String toString() { return "right-agent-sensor"; }
    ...
    public void eval(final EvolutionState state,
        ...
        //Finds which square is to the right of the agent depending on it's facing
        switch (orientation) {
            case 0:
